...
class SearchTeam(models.Model):
    ...
    impressions = models.FloatField('Impressions', default=0)
    clicks = models.FloatField('Clicks', default=0)
    ...
    day_total_sales = models.FloatField('7 Day Total Sales ', default=0)
    ...
    day_total_orders = models.FloatField('7 Day Total Orders', default=0)
...
class PurProduct(models.Model):
    ...
    day_other_sku_units = models.FloatField('7 Day Other SKU Units', default=0)
    day_other_sku_orders = models.CharField('7 Day Other SKU Orders', max_length=225, default='')
    day_other_sku_sales = models.FloatField('7 Day Other SKU Sales', default=0)
    created = models.DateTimeField('Created', auto_now_add=True)
...
class AdvProducts(models.Model):
    ...
    day_total_units = models.CharField('7 Day Total Units', max_length=225, default='')
    day_conversion_rate = models.CharField('7 Day Conversion Rate', max_length=225, default='')
    day_advertised_sku_units = models.FloatField('7 Day Advertised SKU Units', default=0)
    day_other_sku_units = models.CharField('7 Day Other SKU Units', max_length=225, default='')
    day_advertised_sku_sales = models.FloatField('7 Day Advertised SKU Sales', default=0)
    day_other_sku_sales = models.CharField('7 Day Other SKU Sales', max_length=225, default='')
    created = models.DateTimeField('Created', auto_now_add=True)
...
class CampaignPla(models.Model):
    ...
    total_advertising_cost_of_sales = models.CharField('Total Advertising Cost of Sales', max_length=225, default='')
    total_return_on_advertising_spend = models.CharField('Total Return on Advertising Spend', max_length=225, default='')
    day_total_sales = models.FloatField('14 Day Total Sales ', default=0)
...
class BizReport(models.Model):
    ...
    ordered_product_sales = models.FloatField('Ordered Product Sales', default=0)
    created = models.DateTimeField('Created', auto_now_add=True)
...
class FbaAccountingTask(models.Model):
    ...
    date_range = models.CharField('Date Range', max_length=50, default='')
    date_range_end = models.CharField('Date Range End', max_length=50, default='')
