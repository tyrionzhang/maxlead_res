    ...
    for val in data_list:
        ...
        for v in data:
            ...
            if v['sku'] == val.sku:
                ...
                sum = v['exl'] + v['twu'] + v['tfd'] + v['hanover'] + v['pc'] + v['zto'] + v['atl'] + v['rol']
                v.update({'sum': sum})

    if data:
        fields = ['SKU','EXL','TWU','TFD','Hanover','ATL', 'PC', 'ZTO', 'ROL', 'SUM','Created']
        data_fields = ['sku','exl','twu','tfd','hanover','atl', 'pc', 'zto', 'rol', 'sum','date']
