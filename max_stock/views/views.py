...
class perform_command_que(threading.Thread):
    ...
    def run(self):
        ...
        cmd_str2 = 'curl http://localhost:6801/schedule.json -d project=maxlead_scrapy -d spider=twu_spider -d username=%s' % self.username
        cmd_str1 = 'curl http://localhost:6801/schedule.json -d project=maxlead_scrapy -d spider=hanover_spider -d username=%s' % self.username
        cmd_str3 = 'curl http://localhost:6801/schedule.json -d project=maxlead_scrapy -d spider=exl_spider -d username=%s' % self.username
        cmd_str4 = 'curl http://localhost:6801/schedule.json -d project=maxlead_scrapy -d spider=atl1_spider -d username=%s' % self.username
